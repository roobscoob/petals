...
export { ChangeSizeBy } from "./changeSizeBy";

export { ClearGraphicEffects } from "./clearGraphicEffects";
...
export { NextBackdrop } from "./nextBackdrop";

export { NextCostume } from "./nextCostume";

export { Say } from "./say";

export { SayForSeconds } from "./sayForSeconds";

export { SetGraphicEffectTo } from "./setGraphicEffectTo";

export { SetSizeTo } from "./setSizeTo";
...
export { ThinkForSeconds } from "./thinkForSeconds";